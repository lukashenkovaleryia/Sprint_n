...
@allure.title("Открываем окно поиска такси (тариф Рабочий + столик для ноутбука) и получаем стоимость")
@pytest.fixture
def driver_and_order_taxi_with_cost(driver_and_choose_fast_taxi):
    page = GetTaxiPage(driver_and_choose_fast_taxi)
